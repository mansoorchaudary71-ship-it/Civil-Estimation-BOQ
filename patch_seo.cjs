const fs = require('fs');
if (!fs.existsSync('src/components/seo')) {
  fs.mkdirSync('src/components/seo', { recursive: true });
}
...
`;
fs.writeFileSync('src/components/seo/SEOHead.tsx', content);
console.log('SEOHead recreated');
