...
export function SEOContent({ category, data }: SEOContentProps) {
  const renderMetalContent = () => (
    <>
      <h2 className="mt-8 mb-4 text-xl font-semibold text-txt-primary tracking-tight">How to Calculate Weight for {data.diameter_mm}mm {data.profile}</h2>
  ...
  const renderConcreteContent = () => (
    <>
      <h2 className="mt-8 mb-4 text-xl font-semibold text-txt-primary tracking-tight">How to Calculate Material for {data.volume_cft} CFT</h2>
      <p className="mb-4 text-base font-normal text-txt-secondary leading-relaxed">
  ...
  const renderHouseContent = () => (
    <>
      <h2 className="mt-8 mb-4 text-xl font-semibold text-txt-primary tracking-tight">How to Calculate Grey Structure Cost for {data.plot_designation}</h2>
      <p className="mb-4 text-base font-normal text-txt-secondary leading-relaxed">
  ...
  const renderEarthworksContent = () => (
    <>
      <h2 className="mt-8 mb-4 text-xl font-semibold text-txt-primary tracking-tight">How to Calculate Excavation Hauling using {data.calculation_method}</h2>
      <p className="mb-4 text-base font-normal text-txt-secondary leading-relaxed">
  ...
  return (
    <article className="prose prose-indigo max-w-none text-txt-secondary mt-8 font-sans">
      <h1 className="capitalize mb-2 border-b pb-4 text-xl font-semibold text-txt-primary tracking-tight mb-6">
        {data.target_keyword}
      </h1>
      ...
      <h3 className="mt-8 mb-3 text-lg font-medium text-txt-primary mb-4">Standard Allowances and Wastage Factors</h3>
      <p>
