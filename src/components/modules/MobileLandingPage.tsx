...
export default function MobileLandingPage() {
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-8 font-sans">
      ...
      */}
      <div className="relative w-full max-w-md bg-surface-default rounded-2xl shadow-2xl overflow-hidden ring-1 ring-slate-200">
        ...
        */}
        ...
        <MobileTypographyWrapper className="relative z-10 flex flex-col h-full w-full">
          ...
          <div className="w-full px-6 pt-4 pb-2 flex flex-col gap-2">
            <div className="flex justify-between items-center text-[11px] font-medium text-txt-primary">
              <span>11:06</span>
            ...
            <div className="w-full bg-surface-default/50 backdrop-blur-md rounded-full px-4 py-2 flex items-center justify-center border border-white/40 shadow-sm text-xs font-medium text-txt-secondary overflow-hidden">
          ...
          <header className="px-6 py-4 flex items-center justify-between">
            <div className="font-bold text-txt-primary text-lg tracking-tight">
              Civil Est. Pro
            </div>
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <Menu className="w-6 h-6 text-txt-primary sm:hidden" />
            </div>
          </header>
          ...
          <main className="flex-1 px-6 pt-6 pb-24 flex flex-col items-center text-center">
            ...
            {/* Badge */}
            <div className="w-full inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface-default/60 backdrop-blur-md border border-white/50 shadow-sm mb-6 overflow-hidden">
              <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse" />
              <span className="text-base font-medium tracking-wide uppercase">NEW: AI-Powered Estimations</span>
            </div>

            {/* Headlines */}
            <h1 className="text-2xl md:text-xl font-semibold text-txt-primary mb-4 leading-[1.1]">
              <span className="text-slate-400 block mb-1">Build Smarter.</span>
              <span className="text-txt-primary">Estimate <span className="text-blue-500">Faster.</span></span>
            </h1>

            {/* Description Text */}
            <p className="text-[15px] leading-relaxed text-txt-secondary mb-8 max-w-[320px]">
            ...
            <div className="flex flex-col w-full gap-3 mb-12">
              ...
              <Button className="w-full flex items-center justify-center gap-2 bg-surface-default/40 hover:bg-surface-default/60 border border-ui-borderSubtle/60 backdrop-blur-sm text-txt-primary py-3.5 px-6 rounded-full font-semibold transition-transform active:scale-[0.98] transition-all duration-300 active:scale-95 hover:-translate-y-0.5 hover:shadow-lg shadow-sm overflow-hidden">
          ...
          <div className="w-full absolute top-[35%] -left-8 bg-surface-default/80 backdrop-blur-xl p-3 rounded-2xl shadow-xl border border-white flex flex-col gap-2 max-w-[140px] animate-float-slow overflow-hidden">
             <div className="flex items-center gap-1.5">
               <CheckCircle className="w-4 h-4 text-emerald-500" />
               <span className="text-[10px] font-bold text-txt-primary leading-tight">30+ Professional<br/>Tools</span>
             </div>
             ...
             <span className="text-[9px] font-medium text-txt-tertiary">10k+ Trust Us</span>
          </div>

          {/* Floating Social Proof Card 2 */}
          <div className="w-full absolute bottom-[20%] -right-6 bg-surface-default/90 backdrop-blur-xl p-4 rounded-2xl shadow-xl border border-white flex flex-col gap-2 max-w-[180px] animate-float-delayed overflow-hidden">
             <div className="flex gap-0.5">
               {[...Array(5)].map((_, i) => <Star key={i} className="w-3 h-3 fill-orange-400 text-orange-400" />)}
             </div>
             <p className="text-[10px] leading-snug text-txt-secondary italic">
               "Zero calculation errors and saves hours of manual Excel entries."
             </p>
             <div className="flex items-center gap-2 mt-1">
               <div className="w-6 h-6 rounded-full bg-slate-200" />
               <div className="flex flex-col">
                 <span className="text-[9px] font-bold text-txt-primary">Michael R.</span>
                 <span className="text-[8px] text-txt-tertiary">Civil Engineer</span>
               </div>
             </div>
          </div>
