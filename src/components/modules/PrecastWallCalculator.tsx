      ...
      <div className="w-full md:max-w-7xl md:mx-auto px-4 md:px-8 pt-8">
        <div className="mb-8">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <h2 className="text-xl font-semibold text-txt-primary flex items-center gap-3">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-[45%] flex flex-col gap-6">
            <div className="w-full bg-surface-default p-4 sm:p-6 rounded-2xl border border-ui-borderSubtle shadow-sm relative overflow-hidden">
              ...
              <h3 className="font-bold text-lg text-txt-primary mb-6 border-b border-slate-100 pb-4">
                Boundary Dimensions
              </h3>
...
<input id="a11y-input-369"
                    ...
                    className="w-full bg-slate-50 rounded-full border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle text-txt-primary rounded-full px-4 py-3 font-mono text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-indigo-500 transition-all font-semibold"
                  /></>
                </div>
                <div>
...
<input id="a11y-input-370"
              ...
              <h3 className="font-bold text-lg text-txt-primary mb-6 border-b border-slate-100 pb-4 mt-8">
...
<input id="a11y-input-372"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-2">
                <div>
                  <label className="text-[10px] font-bold text-txt-tertiary uppercase tracking-widest block mb-2">Rate/Post</label>
                  <><label htmlFor="a11y-input-373" className="sr-only">Input</label>
<input id="a11y-input-373"
                    type="number" inputMode="decimal"
                    value={postRate}
                    onChange={(e) => setPostRate(e.target.value)}
                    className="w-full bg-slate-50 rounded-full border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle text-txt-primary rounded-full px-3 py-2 font-mono text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-indigo-500 transition-all"
                  /></>
                </div>
                <div>
                  <label className="text-[10px] font-bold text-txt-tertiary uppercase tracking-widest block mb-2">Rate/Slab</label>
...
<input id="a11y-input-374"
                ...
                <div>
                  <label className="text-[10px] font-bold text-txt-tertiary uppercase tracking-widest block mb-2">Labor/{isMetric ? "m" : "ft"}</label>
          ...
          <div className="w-full md:w-[55%]">
            {isProcessing ? (
              ...
              <div className="space-y-6">
                <div className="w-full bg-surface-default p-4 sm:p-6 md:p-4 sm:p-8 rounded-2xl border border-ui-borderSubtle shadow-lg relative overflow-hidden">
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-100 pb-6 mb-6">
                    <div>
                      <span className="text-base font-medium uppercase tracking-widest text-txt-tertiary mb-1 block">Total BOM Cost</span>
                  ...
                  <div className="bg-slate-50 rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary rounded-2xl border border-ui-borderSubtle overflow-hidden mb-8">
                    <table className="w-full text-left text-sm">
                      <thead className="bg-slate-100 rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary border-b border-ui-borderSubtle text-txt-tertiary font-bold uppercase tracking-widest text-[10px] overflow-hidden">
                        <tr>
                      ...
                      <tbody className="divide-y divide-slate-100">
                        <tr>
                          <td className="px-4 py-3 font-semibold text-txt-primary">H-Column Posts</td>
                        ...
                        <tr>
                          <td className="px-4 py-3 font-semibold text-txt-primary">Precast Slabs</td>
                        ...
                        <tr>
                          <td className="px-4 py-3 font-semibold text-txt-primary">Installation/Labor</td>
                        ...
                        <tr className="bg-slate-100/50 rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary overflow-hidden">
                          <td colSpan={3} className="px-4 py-3 font-bold text-txt-primary text-right">Total Estimates</td>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="bg-slate-50 rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary p-4 rounded-2xl border border-ui-borderSubtle shadow-sm text-center overflow-hidden">
                      <span className="text-txt-tertiary text-[10px] font-bold uppercase tracking-widest block mb-1">Total Bays Formed</span>
                      <div className="text-xl font-semibold tabular-nums tracking-tight text-txt-primary">{estimateData.numberOfBays}</div>
                    </div>
                    <div className="bg-slate-50 rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary p-4 rounded-2xl border border-ui-borderSubtle shadow-sm text-center overflow-hidden">
                      <span className="text-txt-tertiary text-[10px] font-bold uppercase tracking-widest block mb-1">Slabs per Bay</span>
                      <div className="text-xl font-semibold tabular-nums tracking-tight text-txt-primary">{estimateData.slabsPerBay}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[400px] flex flex-col items-center justify-center bg-slate-50 rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary rounded-2xl border-2 border-dashed border-ui-borderSubtle p-4 sm:p-8 md:p-8 text-center bg-graph-pattern opacity-80 mix-blend-multiply overflow-hidden">
                ...
                <h3 className="text-xl font-semibold text-txt-secondary mb-2">Build the Wall</h3>
