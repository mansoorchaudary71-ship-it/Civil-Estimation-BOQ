  ...
  return (
    <div className="w-full h-full bg-transparent text-txt-primary dark:text-white p-6 md:p-8">
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="bg-bg-card rounded-2xl shadow-sm border border-ui-borderSubtle dark:border-slate-700 overflow-hidden">
          <div className="p-6 md:p-8 space-y-8">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
              {/* Inputs */}
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-lg mb-4 text-txt-primary border-b border-slate-100 pb-2">Catchment Details</h3>
...
<input id="a11y-input-408" type="number" inputMode="decimal" className="w-full bg-surface-default dark:bg-slate-800 rounded-full border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle rounded-l-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-[#0284c7]/50 min-h-[44px]" value={roofArea} onChange={(e) => setRoofArea(e.target.value)} /></>
                        <select className="bg-slate-50 border border-l-0 border-ui-borderSubtle rounded-r-xl px-2 py-3 outline-none" value={areaUnit} onChange={(e) => setAreaUnit(e.target.value)}>
...
<input id="a11y-input-409" type="number" inputMode="decimal" className="w-full bg-surface-default dark:bg-slate-800 rounded-full border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle rounded-full px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-[#0284c7]/50 min-h-[44px]" value={rainfall} onChange={(e) => setRainfall(e.target.value)} /></>
                    </div>

                    <div className="flex flex-col gap-2 col-span-2">
                      <label className="text-base font-medium">Runoff Coefficient</label>
                      <select className="w-full bg-surface-default rounded-2xl border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle rounded-2xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-[#0284c7]/50 overflow-hidden" value={coefficient} onChange={(e) => setCoefficient(e.target.value)}>
                ...
                <div>
                  <h3 className="font-bold text-lg mb-4 text-txt-primary border-b border-slate-100 pb-2">Financials</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
...
<input id="a11y-input-410" type="number" inputMode="decimal" className="w-full bg-surface-default dark:bg-slate-800 rounded-full border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle rounded-full pl-8 pr-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-emerald-500/50 min-h-[44px]" value={muniWaterCost} onChange={(e) => setMuniWaterCost(e.target.value)} /></>
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
...
<input id="a11y-input-411" type="number" inputMode="decimal" className="w-full bg-surface-default dark:bg-slate-800 rounded-full border border-ui-borderSubtle shadow-sm text-txt-primary border border-ui-borderSubtle rounded-full pl-8 pr-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-emerald-500/50 min-h-[44px]" value={setupCost} onChange={(e) => setSetupCost(e.target.value)} /></>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Schematic Diagram */}
              <div className="bg-slate-50 border border-ui-borderSubtle rounded-2xl p-4 sm:p-6 flex flex-col items-center justify-center min-h-[300px] shadow-sm relative overflow-hidden">
                <h4 className="font-bold text-txt-tertiary uppercase tracking-wider text-sm mb-4">System Schematic</h4>
            ...
            <div className="pt-6 border-t border-slate-100">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-sky-50 border border-sky-100 rounded-2xl p-4 overflow-hidden">
                  ...
                  <div className="mt-1">
                    <span className="text-xl font-semibold text-txt-primary tabular-nums tracking-tight text-sky-600">{annualVolLiters.toLocaleString(undefined, {maximumFractionDigits: 0})}</span>
                ...
                <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-4 overflow-hidden">
                  <div className="flex items-center gap-2 mb-2">
                    <Settings className="w-5 h-5 text-indigo-500" />
                    <h3 className="text-base font-medium text-indigo-800 uppercase tracking-tight">Rec. Tank</h3>
                  </div>
                  <div className="mt-1">
                    <span className="text-xl font-semibold text-txt-primary tabular-nums tracking-tight text-indigo-600">{recommendedTankLiters.toLocaleString(undefined, {maximumFractionDigits: 0})}</span>
                ...
                <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 overflow-hidden">
                  <div className="flex items-center gap-2 mb-2">
                    <Wallet className="w-5 h-5 text-emerald-500" />
                    <h3 className="text-base font-medium text-emerald-800 uppercase tracking-tight">Payback</h3>
                  </div>
                  <div className="mt-1">
                    <span className="text-xl font-semibold text-txt-primary tabular-nums tracking-tight text-emerald-600">{paybackPeriod.toFixed(1)}</span>
                ...
                <div className="bg-rose-50 border border-rose-100 rounded-2xl p-4 overflow-hidden">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="mt-1">
                    <span className="text-xl font-semibold text-txt-primary tabular-nums tracking-tight text-rose-600">{co2Savings.toFixed(1)}</span>
