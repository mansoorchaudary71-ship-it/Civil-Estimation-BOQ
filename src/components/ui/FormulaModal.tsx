      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 m-auto w-full max-w-lg h-fit max-h-[85vh] bg-surface-default dark:bg-slate-900 rounded-2xl shadow-2xl z-[201] overflow-hidden border border-slate-100 dark:border-slate-800 flex flex-col"
          >
            ...
            <div className="p-6 overflow-y-auto w-full">
              ...
              <div className="space-y-4">
                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-700/50 overflow-hidden">
                  <h4 className="text-sm font-semibold text-txt-primary dark:text-slate-200 mb-3 uppercase tracking-wider">Methodology Description</h4>
                  <div className="text-txt-secondary dark:text-slate-400 text-sm leading-relaxed whitespace-pre-wrap font-mono">
                    {formulaDescription}
                  </div>
                </div>
              </div>
