      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 w-[320px] max-w-[85vw] sm:w-[380px] bg-surface-default border border-ui-borderSubtle shadow-2xl rounded-2xl overflow-hidden flex flex-col"
          >
            <div className="bg-[#FFFFFF] border-b border-ui-borderSubtle p-4 flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center bg-[rgba(255,255,255,0.05)] rounded p-0.5 border border-[rgba(255,255,255,0.08)]">
                    <Button 
                      ...
                      className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-sm transition-colors ${unit === 'sq.ft' ? 'bg-[#F59E0B] text-txt-primary' : 'text-[#94A3B8] hover:text-[#F1F5F9]'}`}
                    >
                      sq.ft
                    </Button>
                    <Button 
                      onClick={() => setUnit('sq.m')}
                      className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-sm transition-colors ${unit === 'sq.m' ? 'bg-[#F59E0B] text-txt-primary' : 'text-[#94A3B8] hover:text-[#F1F5F9]'}`}
                    >
                      sq.m
                    </Button>
                  </div>
...
<input id="a11y-input-588"
              ...
              {result ? (
                ...
                <Button
                  ...
                  className="mt-2 w-full bg-[#F59E0B] hover:bg-[#D97706] text-txt-primary font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
                >
            ...
            <div className="bg-[#FFFFFF] border-t border-ui-borderSubtle p-3">
      ...
      <Button
        ...
        className="w-14 h-14 bg-[#F59E0B] hover:bg-[#D97706] text-txt-primary rounded-full shadow-[0_8px_30px_rgba(245,158,11,0.3)] flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
